...
const Hero = () => {
  return (
    <section id="about" className="pt-[90px] pb-12 px-3 md:px-6 xl:px-8 2xl:px-12 relative min-h-screen flex items-center">
      ...
      <div className="max-w-6xl 2xl:max-w-7xl mx-auto relative z-10 w-full">
        {/* Main Content Frame */}
        <div className="bg-white border-2 md:border-4 border-neo-black p-0.5 md:p-1 shadow-neo-lg rotate-1 h-[558px] md:h-auto">
          <div className="border-2 border-neo-black p-4 md:p-4 2xl:p-8 bg-white relative h-[549px] md:h-auto">
            {/* Top Bar */}
            ...
            <div className="mt-3 md:mt-5 2xl:mt-8 flex flex-col lg:grid lg:grid-cols-12 gap-4 md:gap-3 2xl:gap-6 items-center">
              {/* Left Column - All Text Content */}
              <div className="w-full lg:col-span-7 flex flex-col gap-2 md:gap-3 2xl:gap-5 relative mt-5 lg:-mt-3">
                {/* Decorative blob behind everything - Hidden on mobile */}
                <div className="hidden md:block absolute top-[55%] left-[42%] -translate-x-1/2 -translate-y-1/2 w-[280px] h-[280px] md:w-[520px] md:h-[520px] lg:w-[610px] lg:h-[610px] 2xl:w-[760px] 2xl:h-[760px] opacity-20 z-0">
                ...
                <div className="inline-flex self-start -rotate-2 relative z-20 order-1 lg:order-none">
                ...
                {/* Subtext Box - Order 3 on mobile */}
                <div className="bg-white border-2 border-neo-black p-1 md:p-2 2xl:p-4 shadow-neo max-w-md 2xl:max-w-xl transform -rotate-1 relative z-20 order-3 lg:order-none">
                ...
                {/* CTA Buttons - Order 3 on mobile */}
                <div className="flex flex-wrap gap-1.5 md:gap-2 2xl:gap-3 pt-1 md:pt-1.5 relative z-20 order-3 lg:order-none">
                  <a
                    href="#contact"
                ...
                {/* Social Links - Order 3 on mobile */}
                <div className="flex gap-1.5 md:gap-2 2xl:gap-3 pt-1 md:pt-1.5 relative z-20 order-3 lg:order-none">
                  <a
              ...
              {/* Right Column - Image Section - Order 2 on mobile */}
              <div className="w-full lg:col-span-5 relative h-full min-h-[220px] md:min-h-[315px] 2xl:min-h-[400px] flex items-end justify-center order-2 lg:order-none mt-3 md:mt-0" >
                {/* Panel Background */}
                ...
                <div className="relative z-20 transform -rotate-3 hover:rotate-0 transition-transform duration-500 hover:scale-105 origin-bottom">
                  ...
                  {/* GPA Badge */}
                  <div className="absolute top-3 right-3 md:top-4 md:right-0 bg-neo-yellow neo-brutalism-border px-1.5 py-0.5 md:px-2.5 md:py-0.5 2xl:px-4 2xl:py-2 shadow-neo-sm rotate-6">
